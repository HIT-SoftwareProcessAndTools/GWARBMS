 ...
 */
@GwarbmsEndPoint
public class GwarbmsMetricsEndpoint {

    private final MeterRegistry registry;

    public GwarbmsMetricsEndpoint(MeterRegistry registry) {
    ...
    @ReadOperation
    public GwarbmsMetricResponse metric(@Selector String requiredMetricName, @Nullable List<String> tag) {
        ...
        if (meters.isEmpty()) {
            ...
            return new GwarbmsMetricResponse(requiredMetricName, meterId.getDescription(), meterId.getBaseUnit(), this.asList(samples, Sample::new), this.asList(availableTags, AvailableTag::new));
        }
    }
    ...
    public static final class GwarbmsMetricResponse {
        ...
        GwarbmsMetricResponse(String name, String description, String baseUnit, List<Sample> measurements, List<AvailableTag> availableTags) {
            this.name = name;
