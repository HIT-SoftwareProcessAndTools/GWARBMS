...
public class LoginLogController extends BaseController {
    ...
    public GwarbmsResponse loginLogList(LoginLog loginLog, QueryRequest request) {
    ...
    public GwarbmsResponse deleteLogss(@NotBlank(message = "{required}") @PathVariable String ids) {
