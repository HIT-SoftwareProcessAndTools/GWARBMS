...
--
-- Table structure for table `t_points_rule`
--
...
--
-- Dumping data for table `t_points_rule`
--

LOCK TABLES `t_points_rule` WRITE;
/*!40000 ALTER TABLE `t_points_rule` DISABLE KEYS */;
INSERT INTO `t_points_rule` VALUES (1,1,100);
/*!40000 ALTER TABLE `t_points_rule` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2021-01-12  9:45:55
